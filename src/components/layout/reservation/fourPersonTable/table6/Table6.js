...
const Table6 = () => {
  ...
  return (
    <div>
      <form>
        <h2 className={classes.lable}>TABLE 6 </h2>
          ...
          <div className={classes.selectDiv}>
            <div className={classes.divSelect}>
              ...
              <select
                ...
                required
              >
                <option value={"NO OCASSION"}>NO OCCASION</option>
        ...
        <div>
          ...
          {valueReason === ClickCelebrate2 && (
            <div className={classes.celebrateDiv}>
              ...
              <div>
                <span style={{ fontWeight: "bold" }}>BALLOONS</span>
                <input
                  type={"checkbox"}
                  value={"YES"}
                  onClick={(e) => {
        ...
        <div>
          <ButtonBase className={classes.Button} id="6" onClick={handleTable}>
            RESERV
          </ButtonBase>
        </div>
      </form>
